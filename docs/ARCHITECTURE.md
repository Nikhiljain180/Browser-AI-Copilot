...
1. [High-Level System Architecture](#11-high-level-system-architecture)
2. [Logical Separation](#12-logical-separation)
3. [Full Data Flow](#13-full-data-flow)
4. [Design Decisions](#14-why-each-architectural-decision-was-made)
5. [Chrome Extension Internals](#15-chrome-extension-internals-you-must-explain-well)
6. [Sidebar Injection Strategy](#16-sidebar-injection-strategy)
7. [State Management](#17-state-management-across-components)
8. [Every Component Explained (File-by-File)](#2-every-component-explained-file-by-file)
9. [Tool-Based Agent Design](#3-tool-based-agent-design)
10. [Key Concepts](#9-key-concepts-you-must-know-cold)
11. [Quick Reference](#10-quick-reference-cheat-sheet)
...
## 9.6 LLM Function Calling / Tool Use
...
## 9.8 DOM Traversal And Manipulation
...
## 9.10 Prompt Engineering For Structured Outputs
...
## 9.12 WebSocket vs SSE vs Polling
...
## 10.1 One-Page Architecture Summary
